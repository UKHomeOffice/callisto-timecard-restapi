...
#### container command(s)
- [TimeCard.get timecard(timecardDate, timecardOwnerId, tenantId)](https://github.com/UKHomeOffice/callisto-timecard-restapi/docs/container-definition.md#gettimecard) - used to retrieve a timecard. 
